...
namespace CaseManagement.Helpers
{
    ...
    public static class CaseDomain
    {
        ...
        // ─── نوع پرونده (۶ مقدار) ──────────────────────────────────────────
        // Phase 3 — «سایر» به‌صراحت حذف شد: طبقِ تصمیمِ کاربر، نوع درخواست
        // هویتِ اصلیِ پرونده است (TblRequestType) و باید دقیقاً یکی از شش نوعِ
        // مصوب باشد، بدونِ گزینهٔ نامشخص. این آرایه همچنان منبعِ آیتم‌های
        // txtRequestType در FrmCase و TblLookup است.
        ...
        // ─── وضعیت‌های «در جریان» ───────────────────────────────────────────
        // زیرمجموعه‌ای از PreServiceStatuses که عمداً «در انتظار تایید» را کنار
        // می‌گذارد، چون آن وضعیت شمارندهٔ مستقل خودش را در داشبورد دارد. این دو
        // مجموعه با هم کلِ مسیرِ پیش از فعال‌شدن را بدون هم‌پوشانی می‌پوشانند،
        // پس مجموعِ کارت‌های داشبورد دقیقاً برابرِ «کل پرونده‌ها» می‌شود.
        public static readonly string[] InProgressStatuses = { "متقاضی", "در حال بررسی" };

        public const string StatusActive = "فعال";

        // فهرستِ مقادیر برای بندِ IN در SQL — مثلاً 'متقاضی', 'در حال بررسی'.
        // مقادیر از همین کلاس می‌آیند (نه ورودی کاربر)، ولی برای احتیاط
        // آپاستروف‌ها هم escape می‌شوند.
        public static string SqlValueList(string[] values)
        {
